...
The project applies an actuarial–data science approach using Python and Generalized Linear Models (GLMs).
It includes data exploration, feature engineering, model selection, validation, and portfolio-level predictions.

Contents
	•	Case_Interview_Public.ipynb – full notebook including:
...
Key Results
	...
	•	Uncertainty analysis: Confidence intervals derived from the GLM covariance matrix identify higher variability in small or underrepresented risk segments.
